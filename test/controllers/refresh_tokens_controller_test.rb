...
class RefreshTokensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create refresh_token" do
    assert_difference('RefreshToken.count') do
      post refresh_tokens_url, params: { refresh_token: { client_id: @refresh_token.client_id, expires: @refresh_token.expires, token_id: @refresh_token.token_id, user_id: @refresh_token.user_id } }, as: :json
    end
  ...
  test "should update refresh_token" do
    patch refresh_token_url(@refresh_token), params: { refresh_token: { client_id: @refresh_token.client_id, expires: @refresh_token.expires, token_id: @refresh_token.token_id, user_id: @refresh_token.user_id } }, as: :json
    assert_response 200
  end
